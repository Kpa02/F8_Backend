CREATE DATABASE database_01_Kien;

USE database_01_Kien;
...
VALUES (1, 'Khoa hoc A', 100, 'Mo ta khoa hoc 1A', 'Noi dung khoa hoc A', 1, 1, NOW(), NOW());

INSERT INTO courses (id, name, price, description, content, teacher_id, active, created_at, updated_at)
VALUES (2, 'Khoa hoc B', 150, 'Mo ta khoa hoc 1B', 'Noi dung khoa hoc B', 1, 1, NOW(), NOW());

INSERT INTO courses (id, name, price, description, content, teacher_id, active, created_at, updated_at)
VALUES (3, 'Khoa hoc C', 200, 'Mo ta khoa hoc 1C', 'Noi dung khoa hoc C', 1, 1, NOW(), NOW());
